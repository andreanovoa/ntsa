...
| `rosenstein_lyapunov(x, dt, ...)` | **Data-only** $\lambda_1$ from a scalar series (Rosenstein et al. 1993): Theiler-windowed nearest-neighbour divergence, fitted with `fit_log_growth` — no model equations needed. |
